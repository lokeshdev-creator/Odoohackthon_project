...
export function MaintenanceClient({ logs, vehicles }: MaintenanceClientProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filter Section */}
      <div className="grid grid-cols-3 gap-2 sm:flex sm:flex-row sm:items-center sm:justify-between bg-white p-3 sm:p-4 rounded-xl border border-zinc-200 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <select
          ...
          className="rounded-lg border border-zinc-200 bg-zinc-50 px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm text-zinc-700 outline-none dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300 w-full sm:w-48 focus:border-sky-500 focus:ring-2 focus:ring-sky-100 cursor-pointer"
        >
                  ...
                  >
                    <td className="whitespace-nowrap px-6 py-4">
                      {log.vehicleId ? (
                        ...
                        <span className="text-red-500">Retired Vehicle</span>
                      )}
                    </td>
                    <td className="whitespace-nowrap px-6 py-4 font-semibold text-zinc-800 dark:text-zinc-200">
                      {log.type}
                    </td>
                    <td className="px-6 py-4 text-xs max-w-xs truncate text-zinc-600 dark:text-zinc-400">
                      {log.description}
                    </td>
