...
export function TripsClient({ trips, availableVehicles, availableDrivers }: TripsClientProps) {
  ...
  const getStatusBadge = (s: string) => {
    switch (s) {
      ...
      case "Cancelled":
        return "bg-red-50 text-red-700 border-red-250 dark:bg-red-950/20 dark:text-red-400 dark:border-red-800/30";
      default:
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap px-6 py-4">
                      {t.vehicleId ? (
                        ...
                        <span className="text-red-550">Unassigned</span>
                      )}
                    </td>
                    <td className="whitespace-nowrap px-6 py-4 text-zinc-650 dark:text-zinc-400">
                      {t.driverId?.name || <span className="text-red-550">Unassigned</span>}
                    </td>
                    <td className="whitespace-nowrap px-6 py-4 text-zinc-650 dark:text-zinc-400">
                        ...
                        {t.status === "Draft" && (
                          <>
                            ...
                            <button
                              ...
                              className="rounded border border-red-200 p-1 text-red-650 hover:bg-red-50 dark:border-red-950/20"
                              title="Cancel Draft"
                            >
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div className="flex justify-end gap-3 border-t border-zinc-200 pt-4 dark:border-zinc-800">
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="rounded-lg border border-zinc-200 bg-white px-4 py-2 text-sm font-semibold text-zinc-700 hover:bg-zinc-50 dark:border-zinc-855 dark:bg-zinc-950 dark:text-zinc-350 dark:hover:bg-zinc-800"
                >
                  Cancel
                </button>
                <button
            ...
            <form onSubmit={handleCompleteSubmit} className="mt-4 space-y-4">
              ...
              <div className="flex justify-end gap-3 border-t border-zinc-200 pt-4 dark:border-zinc-800">
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 disabled:opacity-50"
                >
