...
export function TripsClient({ trips, availableVehicles, availableDrivers }: TripsClientProps) {
  ...
  const getStatusBadge = (s: string) => {
    switch (s) {
      case "Draft":
        return "bg-zinc-50 text-zinc-650 border-zinc-200 dark:bg-zinc-800/20 dark:text-zinc-400 dark:border-zinc-700/30";
      case "Dispatched":
      ...
      case "Cancelled":
        return "bg-red-50 text-red-750 border-red-200 dark:bg-red-950/20 dark:text-red-400 dark:border-red-800/30";
      default:
